...
const software=document.querySelector('.more1link');
const c1=document.querySelector('.c1');
const second=document.querySelector('.more2link');
const c2=document.querySelector('.c2');
const Entertainment=document.querySelector('.more3link');
const c3=document.querySelector('.c3');
const Business=document.querySelector('.more4link');
const c4=document.querySelector('.c4');
const fifth=document.querySelector('.more5link');
const c5=document.querySelector('.c5');
const Other=document.querySelector('.more6link');
